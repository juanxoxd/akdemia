...
const menuItems: MenuItem[] = [
    ...
    { label: 'Mis Resultados', icon: 'stats-chart-outline', route: '/my-results', section: 'student' },

    // Admin Section
    { label: 'Crear Examen', icon: 'add-circle-outline', route: '/admin/create-exam', section: 'admin' },
    { label: 'Gestión de Exámenes', icon: 'settings-outline', route: '/admin/exams', section: 'admin' },
